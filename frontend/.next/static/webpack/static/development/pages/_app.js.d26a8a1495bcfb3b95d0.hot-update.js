...
function loadFollowingsAPI(userId) {
  var offset = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
  var limit = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 3;
  return axios__WEBPACK_IMPORTED_MODULE_3___default.a.get("/user/".concat(userId || 0, "/followingsoffset=").concat(offset, "&limit=").concat(limit), {
    withCredentials: true
  });
}
...
//# sourceMappingURL=_app.js.d26a8a1495bcfb3b95d0.hot-update.js.map