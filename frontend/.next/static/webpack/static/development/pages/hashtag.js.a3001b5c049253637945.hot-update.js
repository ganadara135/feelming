  ...
  return Object(immer__WEBPACK_IMPORTED_MODULE_0__["default"])(state, function (draft) {
    switch (action.type) {
      ...
      case LOAD_FOLLOWERS_REQUEST:
        {
          ...
          draft.hasMoreFollower = action.offset ? draft.hasMoreFollower : true; // return {
          //     ...state,
      ...
      case LOAD_FOLLOWERS_SUCCESS:
        {
          ...
          draft.hasMoreFollower = action.data.length === 3; // return {
          //   ...state,
      ...
      case LOAD_FOLLOWINGS_REQUEST:
        {
          ...
          draft.hasMoreFollowing = action.offset ? draft.hasMoreFollowing : true; // return {
          //     ...state,
      ...
      case LOAD_FOLLOWINGS_SUCCESS:
        {
          ...
          draft.hasMoreFollowing = action.data.length === 3; // return {
          //   ...state,
      ...
      case REMOVE_POST_OF_ME:
        {
          draft.isEditingNickname = false;
          draft.editNicknameErrorReason = action.error; // return {
          //   ...state,
          //   me: {
          //       ...state.me,
...
//# sourceMappingURL=hashtag.js.a3001b5c049253637945.hot-update.js.map