...
function* watchLogin() {
  while (true) {
    yield Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__["take"])(_reducers_user__WEBPACK_IMPORTED_MODULE_1__["LOG_IN_REQUEST"], login); // take 안에 gernerater.next() 기능이 있음
