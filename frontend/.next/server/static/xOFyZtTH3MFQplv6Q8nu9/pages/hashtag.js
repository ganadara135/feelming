...
/* harmony import */ var _containers_PostCard__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("uor+");
...
const Hashtag = ({
  ...
  const onScroll = Object(react__WEBPACK_IMPORTED_MODULE_0__["useCallback"])(() => {
    if (window.scrollY + document.documentElement.clientHeight > document.documentElement.scrollHeight - 300) {
      if (hasMorePost) {
        dispatch({
          type: _reducers_post__WEBPACK_IMPORTED_MODULE_3__[/* LOAD_HASHTAG_POSTS_REQUEST */ "n"],
  ...
  return __jsx("div", null, mainPosts.map(c => __jsx(_containers_PostCard__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"], {
    key: c.id,
    post: c
  })));
};
