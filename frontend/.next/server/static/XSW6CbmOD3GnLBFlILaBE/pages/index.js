...
// EXTERNAL MODULE: ./containers/PostCard.js + 5 modules
var PostCard = __webpack_require__("uor+");
...
// CONCATENATED MODULE: ./containers/PostForm.js
...
const PostForm = () => {
  ...
  }, "\uC0C9\uC0C9")), __jsx("div", null, imagePaths.map((v, i) => __jsx("div", {
    key: v,
    style: {
...
/* harmony default export */ var containers_PostForm = (PostForm);
...
const Home = () => {
  ...
  const countRef = Object(external_react_["useRef"])([]);
  const onScroll = Object(external_react_["useCallback"])(() => {
    ...
    if (window.scrollY + document.documentElement.clientHeight > document.documentElement.scrollHeight - 300) {
      if (hasMorePost) {
        ...
        if (!countRef.current.includes(lastId)) {
          dispatch({
            type: post["q" /* LOAD_MAIN_POSTS_REQUEST */],
            lastId
          });
        }
  ...
  return pages_jsx("div", null, me && pages_jsx(containers_PostForm, null), mainPosts.map(c => {
...
/* harmony default export */ var pages = __webpack_exports__["default"] = (Home); // function mapStateToProps(state) {
//     return {
//         user: state.user,
//     };
// }
...
const PostCard = ({
  ...
  const chk_id = Object(external_react_["useRef"])(id); // Dom 에 직접 접근하기도하고, 값을 기억하지만 리렌더링하고 싶지 않을때도 사용
  ...
  }), external_moment_default()(post.createdAt).format('YYYY.MM.DD.')), commentFormOpened && PostCard_jsx(external_react_default.a.Fragment, null, PostCard_jsx(containers_CommentForm, {
    post: post
