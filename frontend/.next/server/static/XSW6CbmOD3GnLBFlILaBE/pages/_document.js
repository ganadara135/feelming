...
class _document_MyDocument extends document_default.a {
  static getInitialProps(context) {
    ...
    return Object(objectSpread["a" /* default */])({}, page, {
      helmet: external_react_helmet_default.a.renderStatic(),
      styledTags
    });
  }
  ...
  render() {
    ...
    return __jsx("html", htmlAttrs, __jsx("head", null, this.props.styledTags, values_default()(helmet).map(el => el.toComponent())), __jsx("body", bodyAttrs, __jsx(next_document["Main"], null), __jsx(next_document["NextScript"], null)));
  }

}

_document_MyDocument.propTypes = {
  helmet: external_prop_types_default.a.object.isRequired,
  styledTags: external_prop_types_default.a.object.isRequired
};
