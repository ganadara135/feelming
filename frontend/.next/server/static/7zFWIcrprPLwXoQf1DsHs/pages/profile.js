...
// EXTERNAL MODULE: ./containers/PostCard.js + 3 modules
...
// CONCATENATED MODULE: ./containers/NicknameEditForm.js
...
/* harmony default export */ var containers_NicknameEditForm = (NicknameEditForm);
...
const Profile = () => {
  ...
  return profile_jsx("div", null, profile_jsx(containers_NicknameEditForm, null), profile_jsx(external_antd_["List"], {
    style: {
      marginBottom: '20px'
    },
    grid: {
    ...
    size: "small",
    header: profile_jsx("div", null, " \uD314\uB85C\uC719 \uBAA9\uB85D "),
    loadMore: hasMoreFollowing && profile_jsx(external_antd_["Button"], {
      style: {
        width: '100%'
      },
    ...
    renderItem: item => profile_jsx(external_antd_["List"].Item, {
      style: {
        marginTop: '20px'
      }
    }, profile_jsx(external_antd_["Card"], {
      actions: [profile_jsx(external_antd_["Icon"], {
        key: "icon",
        type: "stop"
      })],
      onClick: onUnfollow(item.id)
    }, profile_jsx(external_antd_["Card"].Meta, {
      description: item.nickname
    })))
  }), profile_jsx(external_antd_["List"], {
    style: {
      marginBottom: '20px'
    },
    grid: {
    ...
    size: "small",
    header: profile_jsx("div", null, " \uD314\uB85C\uC6CC \uBAA9\uB85D "),
    loadMore: hasMoreFollower && profile_jsx(external_antd_["Button"], {
      style: {
        width: '100%'
      },
